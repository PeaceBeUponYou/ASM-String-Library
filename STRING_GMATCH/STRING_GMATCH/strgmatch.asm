.code
stringMatchMain proc ;//stringMatchMain(*sourceString=rcx,*toFindString=rdx,*startFrom(long int)=r8,*result=r9),
 enter 0,0
 sub rsp, 20h
 push rcx 
 push rdx
...
returning:
 ...
 ret
stringLength endp
matchChars proc ;matchChars(*sourceString,*toFindString,StartIndex,*tempVars,matchCount,tF_length,*timesdone,*result)
    enter 0,0 
    mov rcx,[rbp+40h] 
    add qword ptr [rcx],8
    mov rsi,[rbp+18h]
